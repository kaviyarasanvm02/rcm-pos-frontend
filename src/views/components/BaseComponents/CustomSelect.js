 ...
 * @returns 
 */
const CustomSelect = ({ size, value=null, recordList, labelField, handleChange, placeholder,
  ...
  return (
    <>
      <Select
        ...
        value={ value === "NA" ? null : (labelField && value) ? value : (!labelField && value) ? { label: value, value } : ""}
        name={labelField}
        isLoading={isLoading}
